...
2. Call list_artifacts only if you need to confirm existing outputs.
3. Call publish_status_event with agentName set to "Session Monitor", a short message, a confidenceScore from 0.00 to 1.00, any riskFlags, and a nextAction.
4. If confidenceScore is at least 0.80 and the build has enough detail to produce a first design brief, call transfer_to_design_planner.
